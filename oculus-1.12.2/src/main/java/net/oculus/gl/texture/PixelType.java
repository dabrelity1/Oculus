...
/**
 * Mirrors the Iris {@code PixelType} enumeration so that shader pack metadata can be ported
 * without rewriting every consumer. Only a few entries are needed right now, but keeping the
 * exhaustive list helps future backports reuse the same parser output.
 */
