...
/**
 * Enumerates the pixel formats used by shader pack textures. The structure mirrors the
 * Iris implementation so pack metadata can be consumed without additional adapters.
 */
public enum PixelFormat {
    ...
    PixelFormat(int glFormat, GlVersion minimumGlVersion, boolean integer) {
