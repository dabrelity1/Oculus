...
/**
 * Defines the extended vertex formats used by the Oculus shader pipeline.
 * These formats mirror the 1.16.5 layout but are adapted for the legacy 1.12 runtime.
 */
public final class OculusVertexFormats {
    ...
    static {
        ...
        List<VertexFormatElement> terrainElements = new ArrayList<>();
        List<VertexFormatElement> entityElements = new ArrayList<>();
        ...
        TERRAIN = new VertexFormat(terrainElements);
        ENTITY = new VertexFormat(entityElements);
    }

    private OculusVertexFormats() {
    }
}
